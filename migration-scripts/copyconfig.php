...
ci3_config_path = os.path.join(base_path, ci3_folder, "application", "config", "config.php")
ci4_config_path = os.path.join(base_path, ci4_folder, "app", "Config", "App.php")
...
try:
    ...
    # Copy CI3 config file to CI4 config directory
